...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2021 a las 15:35:30
...
CREATE TABLE `escuderias` (
  ...
  `tipo_motor` varchar(20) COLLATE utf8_spanish_ci NOT NULL
...
CREATE TABLE `pilotos` (
  ...
  `id_escuderia` varchar(10) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
